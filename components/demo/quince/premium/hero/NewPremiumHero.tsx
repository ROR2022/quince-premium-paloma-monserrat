...
export function NewPremiumHero() {
  ...
  const displayImages = useMemo(() => images.length > 0 ? images : [fallbackImage], [images, fallbackImage])
  ...
  }, [displayImages, debug, imagesLoaded.size])
  ...
  }, [currentSlide, displayImages, isClient, debug])
  ...
  }, [isTransitioning, isClient, debug])
